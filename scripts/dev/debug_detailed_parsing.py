...
def test_step_by_step():
    ...
    print("Step 1 - Extracted from dict:")
    print(f"  title: '{title}'")
    ...
    print(
        f"  Match: {has_vietnamese_labels.group() if has_vietnamese_labels else 'None'}"
    )
    ...
    if has_vietnamese_labels:
        ...
        if m_abstract:
            ...
            print("  No abstract found with Vietnamese pattern")

            # Try English pattern
            m_abstract2 = re.search(
            ...
            if m_abstract2:
                ...
                print("  No abstract found with English pattern")
