...
from .config import LoggingConfig, get_logging_config, configure_python_logging
...
def get_performance_summary(
    ...
    for op in operations:
        ...
        percentage = (op_duration / total_duration_ms * 100) if total_duration_ms > 0 else 0
