...
from .logger import get_logger, log_performance, log_error, generate_request_id
    ...
    async def __call__(self, scope: "Scope", receive: "Receive", send: "Send") -> None:
        ...
        if self.log_requests:
            self.logger.info(
                ...
                extra={
                    ...
                    "remote_addr": scope.get("client", ["unknown"])[0] if scope.get("client") else "unknown",
                }
            )
        ...
        try:
            ...
            self.performance_logger.log_operation(
                ...
                duration_ms=duration_ms,
                success=response_info["status_code"] < 400 if response_info["status_code"] else False,
                request_id=request_id,
...
class LoggingMiddleware:
    ...
    async def _execute_async_with_logging(self, func: Callable, args: tuple, kwargs: dict):
        ...
        self.logger.debug(f"Starting operation: {self.operation_name}", extra=extra_data)
    ...
    def _execute_with_logging(self, func: Callable, args: tuple, kwargs: dict, is_async: bool = False):
