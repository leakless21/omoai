...
class TestConfigValidation(unittest.TestCase):
    ...
    def test_secure_config_loading(self):
        ...
        if secure_config_path.exists():
            ...
            secure_data["paths"]["chunkformer_checkpoint"] = str(self.temp_dir / "checkpoint")
    ...
    def test_model_consistency_validation(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertTrue(any("trust_remote_code=True" in msg for msg in warning_messages))
    ...
    def test_temp_directory_validation(self):
        ...
        api_config = APIConfig(temp_dir=temp_path)
