...
@pytest.mark.parametrize(
    "original_text, llm_text, adopt_case, expected_output",
    [
        ...
        (
            ...
            "This is a test of the new emergency broadcast system.",
            True,
            "This is a test of the new emergency broadcast system.",
        ),
    ],
)
def test_force_preserve_with_alignment(
    original_text, llm_text, adopt_case, expected_output
):
    assert (
        _force_preserve_with_alignment(original_text, llm_text, adopt_case)
        == expected_output
    )
...
@pytest.mark.parametrize(
    "orig_word, llm_word, expected_orig_chars, expected_llm_chars, expected_tags",
    [
        ...
        (
            ...
            ["h", "e", "l", "l", "o"],
            ["H", "e", "l", "l", "o"],
            ["replace", "equal", "equal", "equal", "equal"],
        ),
        ...
        (
            ...
            ["h", "e", "l", "l", "o"],
            ["h", "e", "l", "l", "l", "o"],
            ["equal", "equal", "equal", "equal", "insert", "equal"],
        ),
        ...
        (
            ...
            ["h", "e", "l", "l", "o"],
            ["h", "e", "l", "o"],
            ["equal", "equal", "equal", "delete", "equal"],
        ),
        ...
        (
            ...
            ["k", "i", "t", "t", "e", "n"],
            ["s", "i", "t", "t", "i", "n", "g"],
            ["replace", "equal", "equal", "equal", "replace", "equal", "insert"],
        ),
    ],
)
def test_align_chars(
    orig_word, llm_word, expected_orig_chars, expected_llm_chars, expected_tags
):
...
@pytest.mark.parametrize(
    "orig_words, llm_words, expected_wer",
    [
        # Test case 1: Exact match
...
@pytest.mark.parametrize(
    "orig_text, llm_text, expected_cer",
    [
        # Test case 1: Exact match
        ("hello", "hello", 0.0),
        # Test case 2: One substitution
...
@pytest.mark.parametrize(
    "orig_text, llm_text, expected_per",
    [
...
@pytest.mark.parametrize(
    "orig_text, llm_text, expected_uwer, expected_fwer",
    [
        # Test case 1: Exact match
        ...
        (
            ...
            0.0,
            0.5,
        ),  # U-WER should be 0, F-WER should be 0.5 (substitution of , for .)
        ...
        (
            ...
            0.5,
            0.5,
        ),  # U-WER: "Hello" -> "Hi", F-WER: "Hello," -> "Hi." (1 edit on 2 words)
...
@pytest.mark.parametrize(
    "orig_text, llm_text, expected_diff",
    [
        # Test case 1: Exact match
...
@pytest.mark.parametrize(
    "punctuated_text, segments, expected_segments",
    [
        ...
        (
            ...
            [
                ...
                {"start": 1, "end": 2, "text_raw": "world"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "hello", "text_punct": "Hello,"},
                {"start": 1, "end": 2, "text_raw": "world", "text_punct": "world."},
            ],
        ),
        ...
        (
            ...
            [
                {"start": 0, "end": 1, "text_raw": "hello", "text_punct": "Hello, big"},
                {"start": 1, "end": 2, "text_raw": "world", "text_punct": "world."},
            ],
        ),
        ...
        (
            ...
            [
                {"start": 0, "end": 1, "text_raw": "hello", "text_punct": "Hello,"},
                {"start": 1, "end": 2, "text_raw": "big", "text_punct": ""},
                {"start": 2, "end": 3, "text_raw": "world", "text_punct": "world."},
            ],
        ),
        ...
        (
            "",
            [{"start": 0, "end": 1, "text_raw": "hello"}],
            [{"start": 0, "end": 1, "text_raw": "hello", "text_punct": ""}],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "chúng ta học deep learning và neural network",
            "Chúng ta học deep learning và neural network.",
            True,
            "Chúng ta học deep learning và neural network.",
        ),
        ...
        (
            "tôi làm việc trong lĩnh vực ai",
            "Tôi làm việc trong lĩnh vực AI.",
            True,
            "Tôi làm việc trong lĩnh vực AI.",
        ),
...
def test_force_preserve_with_alignment_vietnamese(
    original_text, llm_text, adopt_case, expected_output
):
    assert (
        _force_preserve_with_alignment(original_text, llm_text, adopt_case)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ["l", "e", "a", "r", "n", "i", "n", "g"],
            ["L", "e", "a", "r", "n", "i", "n", "g"],
            ["replace", "equal", "equal", "equal", "equal", "equal", "equal", "equal"],
        ),
        ...
        (
            ...
            ["t", "ô", "i"],
            ["t", "ô", "i", " ", "ơ", "i"],
            ["equal", "equal", "equal", "insert", "insert", "insert"],
        ),
    ],
)
def test_align_chars_vietnamese(
    orig_word, llm_word, expected_orig_chars, expected_llm_chars, expected_tags
):
    orig_chars, llm_chars, tags = _align_chars(orig_word, llm_word)
    assert orig_chars == expected_orig_chars
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "tôi học AI và machine learning",
            "Tôi học AI và Machine Learning.",
            3 / 6,
            3 / 6,
        ),
...
def test_compute_uwer_fwer_vietnamese(
    orig_text, llm_text, expected_uwer, expected_fwer
):
    uwer, fwer = _compute_uwer_fwer(orig_text, llm_text)
    assert uwer == pytest.approx(expected_uwer)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "tôi là John.",
            [
                {"start": 0, "end": 1, "text_raw": "tôi"},
                {"start": 1, "end": 2, "text_raw": "là"},
                {"start": 2, "end": 3, "text_raw": "john"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "tôi", "text_punct": "tôi"},
                {"start": 1, "end": 2, "text_raw": "là", "text_punct": "là"},
                {"start": 2, "end": 3, "text_raw": "john", "text_punct": "John."},
            ],
        ),
        ...
        (
            "Hôm nay học machine learning.",
            [
                {"start": 0, "end": 1, "text_raw": "hôm"},
                {"start": 1, "end": 2, "text_raw": "nay"},
                {"start": 2, "end": 3, "text_raw": "học"},
                {"start": 3, "end": 4, "text_raw": "machine"},
                {"start": 4, "end": 5, "text_raw": "learning"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "hôm", "text_punct": "Hôm"},
                {"start": 1, "end": 2, "text_raw": "nay", "text_punct": "nay"},
                {"start": 2, "end": 3, "text_raw": "học", "text_punct": "học"},
                {"start": 3, "end": 4, "text_raw": "machine", "text_punct": "machine"},
                {
                    "start": 4,
                    "end": 5,
                    "text_raw": "learning",
        ...
        (
            ...
            [
                {"start": 0, "end": 1, "text_raw": "tôi"},
                {"start": 1, "end": 2, "text_raw": "làm"},
                {"start": 2, "end": 3, "text_raw": "việc"},
                {"start": 3, "end": 4, "text_raw": "tại"},
                {"start": 4, "end": 5, "text_raw": "fpt"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "tôi", "text_punct": "Tôi"},
                {"start": 1, "end": 2, "text_raw": "làm", "text_punct": "làm"},
                {"start": 2, "end": 3, "text_raw": "việc", "text_punct": "việc"},
                {"start": 3, "end": 4, "text_raw": "tại", "text_punct": "tại"},
                {"start": 4, "end": 5, "text_raw": "fpt", "text_punct": "FPT."},
            ],
        ),
        ...
        (
            "Lớp học bắt đầu lúc 9 AM.",
            [
                {"start": 0, "end": 1, "text_raw": "lớp"},
                {"start": 1, "end": 2, "text_raw": "học"},
                {"start": 2, "end": 3, "text_raw": "bắt"},
                {"start": 3, "end": 4, "text_raw": "đầu"},
                {"start": 4, "end": 5, "text_raw": "lúc"},
                {"start": 5, "end": 6, "text_raw": "9"},
                {"start": 6, "end": 7, "text_raw": "am"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "lớp", "text_punct": "Lớp"},
                {"start": 1, "end": 2, "text_raw": "học", "text_punct": "học"},
                {"start": 2, "end": 3, "text_raw": "bắt", "text_punct": "bắt"},
                {"start": 3, "end": 4, "text_raw": "đầu", "text_punct": "đầu"},
                {"start": 4, "end": 5, "text_raw": "lúc", "text_punct": "lúc"},
                {"start": 5, "end": 6, "text_raw": "9", "text_punct": "9"},
                {"start": 6, "end": 7, "text_raw": "am", "text_punct": "AM."},
            ],
        ),
        ...
        (
            "Chúng ta học deep learning và neural network.",
            [
                {"start": 0, "end": 1, "text_raw": "chúng"},
                {"start": 1, "end": 2, "text_raw": "ta"},
                {"start": 2, "end": 3, "text_raw": "học"},
                {"start": 3, "end": 4, "text_raw": "deep"},
                {"start": 4, "end": 5, "text_raw": "learning"},
                {"start": 5, "end": 6, "text_raw": "và"},
                {"start": 6, "end": 7, "text_raw": "neural"},
                {"start": 7, "end": 8, "text_raw": "network"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "chúng", "text_punct": "Chúng"},
                {"start": 1, "end": 2, "text_raw": "ta", "text_punct": "ta"},
                {"start": 2, "end": 3, "text_raw": "học", "text_punct": "học"},
                {"start": 3, "end": 4, "text_raw": "deep", "text_punct": "deep"},
                {
                    "start": 4,
                    "end": 5,
                    "text_raw": "learning",
                ...
                {"start": 5, "end": 6, "text_raw": "và", "text_punct": "và"},
                {"start": 6, "end": 7, "text_raw": "neural", "text_punct": "neural"},
                {"start": 7, "end": 8, "text_raw": "network", "text_punct": "network."},
            ],
        ),
        ...
        (
            "Bạn có biết what is AI không?",
            [
                {"start": 0, "end": 1, "text_raw": "bạn"},
                {"start": 1, "end": 2, "text_raw": "có"},
                {"start": 2, "end": 3, "text_raw": "biết"},
                {"start": 3, "end": 4, "text_raw": "what"},
                {"start": 4, "end": 5, "text_raw": "is"},
                {"start": 5, "end": 6, "text_raw": "ai"},
                {"start": 6, "end": 7, "text_raw": "không"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "bạn", "text_punct": "Bạn"},
                {"start": 1, "end": 2, "text_raw": "có", "text_punct": "có"},
                {"start": 2, "end": 3, "text_raw": "biết", "text_punct": "biết"},
                {"start": 3, "end": 4, "text_raw": "what", "text_punct": "what"},
                {"start": 4, "end": 5, "text_raw": "is", "text_punct": "is"},
                {"start": 5, "end": 6, "text_raw": "ai", "text_punct": "AI"},
                {"start": 6, "end": 7, "text_raw": "không", "text_punct": "không?"},
            ],
        ),
        ...
        (
            ...
            [
                ...
                {"start": 1, "end": 2, "text_raw": "làm"},
                {"start": 2, "end": 3, "text_raw": "việc"},
                {"start": 3, "end": 4, "text_raw": "trong"},
                {"start": 4, "end": 5, "text_raw": "lĩnh"},
                {"start": 5, "end": 6, "text_raw": "vực"},
                {"start": 6, "end": 7, "text_raw": "ai"},
            ],
            [
                {"start": 0, "end": 1, "text_raw": "tôi", "text_punct": "Tôi"},
                {"start": 1, "end": 2, "text_raw": "làm", "text_punct": "làm"},
                {"start": 2, "end": 3, "text_raw": "việc", "text_punct": "việc"},
                {"start": 3, "end": 4, "text_raw": "trong", "text_punct": "trong"},
                {"start": 4, "end": 5, "text_raw": "lĩnh", "text_punct": "lĩnh"},
                {"start": 5, "end": 6, "text_raw": "vực", "text_punct": "vực"},
                {"start": 6, "end": 7, "text_raw": "ai", "text_punct": "AI."},
            ],
        ),
        ...
        (
            "",
            [{"start": 0, "end": 1, "text_raw": "xin"}],
            [{"start": 0, "end": 1, "text_raw": "xin", "text_punct": ""}],
        ),
    ],
)
def test_distribute_punct_to_segments_vietnamese(
    punctuated_text, segments, expected_segments
):
    result = _distribute_punct_to_segments(punctuated_text, segments)
    assert result == expected_segments
...
def test_keep_nonempty_segments_fallback():
    ...
    result_default = _distribute_punct_to_segments(
        punctuated_text, [dict(s) for s in segments]
    )
