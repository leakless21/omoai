...
class TestMetricsCollection(unittest.TestCase):
    ...
    def test_metrics_collector_basic(self):
        ...
        collector.record_performance(
            "operation2", 200.0, success=False, error_type="TEST_ERROR"
        )
    ...
    def test_performance_report_generation(self):
        ...
        collector.record_performance(
            "test_op", 200.0, success=False, error_type="TEST_ERROR"
        )
...
class TestLoggingIntegration(unittest.TestCase):
    ...
    def test_request_id_tracing(self):
        ...
        from omoai.logging_system.logger import (
            generate_request_id,
